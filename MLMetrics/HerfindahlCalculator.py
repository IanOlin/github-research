...
stackfileList = ("cloudstack-apache-commits.json", "cinder-openstack-commits.json", "glance-openstack-commits", "horizon-openstack-commits.json", "keystone-openstack-commits.json", "neutron-openstack-commits.json", "nova-openstack-commits.json", "openstack_contributors_data.json", "swift-openstack-commits.json")

def calculateOverall():
    herfindahlIndices = {}
    for file in mlfileList:
